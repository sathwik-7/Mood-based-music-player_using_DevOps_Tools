let mood, audio, playbtn, nextbtn, prevbtn, mutebtn, seekslider, volumeslider, seeking = false, seekto,
    ...
    happy_playlist, happy_title, happy_poster, calm_playlist, calm_title, calm_poster,
    sad_playlist, sad_title, sad_poster, angry_playlist, angry_title, angry_poster, playlist_index;

dir = "static/songs/"

happy_playlist = ["MeghanTrainor-BetterWhenI'mDancin'", "WillPharrell-Happy", "Kool&TheGang-Celebration", "RickAstley-NeverGonnaGiveYouUp"];
happy_title = ["Meghan Trainor - Better When I'm Dancin'", "Will Pharrell - Happy", "Kool & The Gang - Celebration", "Rick Astley - Never Gonna Give You Up"];
happy_poster = ["static/song_imgs/Better_When_I'm_Dancin'.jpg", "static/song_imgs/happy.jpg", "static/song_imgs/celebration.jpg", "static/song_imgs/never_gonna_give_you_up.jpg"];

calm_playlist = ["OneRepublic-CountingStars", "SmashMouth-AllStar", "DJOkawari-SpeedofLight", "BillieEilish-BadGuy"];
calm_title = ["OneRepublic - Counting Stars", "Smash Mouth - All Star", "DJ Okawari - Speed of Light", "Billie Eilish - Bad Guy"];
calm_poster = ["static/song_imgs/Counting_Stars.jpg", "static/song_imgs/all_star.jpeg", "static/song_imgs/speed_of_light.jpg", "static/song_imgs/bad_guy.jpg"];

sad_playlist = ["Powfu-DeathBed", "Adele-Hello", "CelineDion-MyHeartWillGoOn", "GaryJules-MadWorld"];
sad_title = ["Powfu - Death Bed", "Adele - Hello", "Celine Dion - My Heart Will Go On", "Gary Jules - Mad World"];
sad_poster = ["static/song_imgs/Death_Bed.jpg", "static/song_imgs/hello.JPG", "static/song_imgs/my_heart_will_go_on.jpg", "static/song_imgs/mad_world.jpg"];

angry_playlist = ["ThreeDaysGrace-IHateEverythingAboutYou", "ACDC-BackinBlack", "OhTheLarceny-ManonaMission", "LedZeppelin-ImmigrantSong"];
angry_title = ["Three Days Grace -  I Hate Everything About You", "ACDC - Back in Black", "Oh The Larceny - Man on a Mission", "Led Zeppelin - Immigrant Song"];
angry_poster = ["static/song_imgs/I_Hate_Everything_About_You.jpg", "static/song_imgs/back_in_black.jpg", "static/song_imgs/man_on_a_mission.jpg", "static/song_imgs/immigrant_song.jpg"];
...
function loop() {
    if (audio.loop) {
        ...
        audio.loop = true;
        $("#repeat img").attr("src", "static/imgs/loop1.jpg");
    }
}
        ...
        fetch('/expression', {
            ...
            switch (mood) {
                case "Happy":
                    ...
                    current_song.innerHTML = happy_title[playlist_index];
                    $("#circle-image img").attr("src", happy_poster[playlist_index]);
                    $("body").css("background-image", "linear-gradient(to bottom, rgba(255, 165, 1) 0%, rgba(219, 203, 88, 1) 100%)");
                    break;
                case "Calm":
                    playlist_index = 0;
                ...
                case "Sad":
                    ...
                    current_song.innerHTML = sad_title[playlist_index];
                    $("#circle-image img").attr("src", sad_poster[playlist_index]);
                    $("body").css("background-image", "linear-gradient(to bottom, rgba(79, 34, 247) 69%, rgba(0, 189, 255, 1) 100%)");
                    break;
                case "Angry":
                    playlist_index = 0;
                    ...
                    current_song.innerHTML = angry_title[playlist_index];
                    $("#circle-image img").attr("src", angry_poster[playlist_index]);
                    $("body").css("background-image", "linear-gradient(to bottom, rgb(255, 69, 0) , rgb(245, 0, 76))");
                    break;
            }
        });
    });
